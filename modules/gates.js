...
import { interactiveObjects } from '../src/interaction.js';
...
export function setupGates(scene) {
    ...
    // EXIT SIGN - Dynamic glowing neon green canvas texture
    ...
    // Draw running man/arrow exit icon pointing right
    ...
    const exitSignMat = new THREE.MeshStandardMaterial({
        ...
        emissiveIntensity: 2.2, // Strong green glow
        roughness: 0.1,
        metalness: 0.5
    });
...
export function triggerEndingModal() {
    ...
    // Release pointer lock so user can interact with the button
