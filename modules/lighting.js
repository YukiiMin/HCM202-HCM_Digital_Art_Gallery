...
export const setupLighting = (scene, paintings) => {
  ...
  if (paintings && paintings.length > 0) {
    paintings.forEach((painting, index) => {
      ...
      spot.angle = 0.5;      // Góc mở hẹp tập trung vào tranh
      spot.penumbra = 0.6;    // Viền sáng mềm mại
      spot.decay = 1.2;
      spot.distance = 25;
  ...
  const deskSpotlight = new THREE.SpotLight(0xffa040, 1.8); // Ánh sáng hổ phách ấm áp
